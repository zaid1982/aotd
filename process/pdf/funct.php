...
//    $output = '';
//    $sql = "SELECT
//	phy_sample_info.phyLab_code AS phyLab_code,
//	phy_sample_info.phyLab_sampleCode AS phyLab_sampleCode,
//	phy_test_res.phyRes_res AS phyRes_res
//FROM phy_sample_info
//LEFT JOIN phy_test_res ON phy_test_res.phyLab_code = phy_sample_info.phyLab_code ".$whereSearch." ORDER BY phyLab_code";
//    log_debug(__LINE__, $sql, $GLOBALS['log_dir']);
//    $result = mysqli_query(get_connect(), $sql);    
//    while($row = mysqli_fetch_assoc($result))  
//    {   
//        $output .= '
//            <tr nobr="true">
//                <td width="150">'.$row["phyLab_sampleCode"].'</td>
//                <td width="210">'.$row["phyLab_code"].'</td>
//                <td width="150">'.$row["phyRes_res"].'</td>
//            </tr> ';
//    }  
//    return $output;
//}
