...
try {     
    ...
    /* Process message from server side - no number*/
    else {        
        ...
        if ($_POST['funct'] == 'get_list_general') { 
            ...
            $data = Class_db::getInstance()->db_select_dTable($_POST['tablename'], $columns, '0', '0', '', $sorting[0].' desc', $param, $tableLimit);
            $countData = Class_db::getInstance()->db_count($_POST['tablename'], $columns, $param); 
        } else {
