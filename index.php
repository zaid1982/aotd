...
<html lang="en-us">
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="css/smartadmin-skins.min3.css">
    ...
    -->
    <body class="smart-style-3 fixed-navigation fixed-header fixed-ribbon">
        ...
        <header id="header">
            <div id="logo-group">
                ...
                <span id="logo"> <img src="img/lims-logo1.png"> </span>
                <!--<span id="logo"> <h6>A.O.T.D System </h6> </span>-->
                <!-- END LOGO PLACEHOLDER -->

                <!-- Note: The activity badge color changes when clicked and resets the number to 0
                Suggestion: You may want to set a flag when this happens to tick off all checked messages / notifications -->
                <span id="activity" class="activity-dropdown"> <i class="fa fa-tasks"></i> <b class="badge bg-color-red" id="total_notification"> <span class="total_notification">2</span> </b> </span>
                        ...
                        <ul class="notification-body" id="content-notify-info">                            
                            <li>
                                <span class="padding-10">
                                    ...
                                    <span>
                                        <a href="javascript:void(0);" class="display-normal"><strong>Test</strong></a>: <span id="lbl_notify_total_fail_pooling"></span> 15 new sample come today
...
<!--                            <li>
            ...
            <div class="pull-right">
                ...
                <div id="ss" class="btn-header pull-right">
                    <span> <a href="javascript:void(0);" data-toggle="modal" title="User Profile" onclick="f_mus_load_user(2,<?=$_SESSION['user_id']?>,'idx');"><i class="fa fa-user"></i></a> </span>
                </div>
...
<!--                <ul class="header-dropdown-list hidden-xs">
        ...
        <!-- PAGE FOOTER -->
        <div class="page-footer" style="background-color: #008478">
            <div class="row">
                <div class="col-xs-12 col-sm-12">
                    <span class="txt-color-white">A.O.T.D <span class="hidden-xs"> - Laboratory Information Management System 2.0 </span> © 2017</span>
                </div>
            </div>
        </div>
        <!-- END PAGE FOOTER -->
        ...
        include 'view/modal/modal_upload.php';
        include 'view/modal/modal_view_document.php';
        ?>
...
<!--        <script type="text/javascript" src="//cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>-->
        ...
        <!--<script  src="js/JsBarcode/JsBarcode.code128.min.js"></script>-->
        ...
        include 'view/js/j_modal_upload.php';
        include 'view/js/j_modal_view_document.php';
        ?>
        ...
        <script type="text/javascript">
            ...
            function f_main_alert() {
                ...
                var notify_task = f_get_general_info_multiple('dt_notify_task', {}, {}, '', 'wfTask_timeCreated DESC');
                if (notify_task.length > 0) {
                    $.each(notify_task, function(u){
                        var html = '<li><span class="padding-10"><em class="badge padding-5 no-border-radius bg-color-'+notify_task[u].wfFlow_color+' txt-color-white pull-left margin-right-5">' + 
                            '<i class="fa '+notify_task[u].wfTaskType_icon+' fa-fw fa-2x"></i></em>' +
                            '<span class="text-muted"><strong>'+notify_task[u].wfFlow_short+' - </strong>'+notify_task[u].wfTaskType_name+'</span><br><strong>'+replaceNull(notify_task[u].client_organisation, '-')+'</strong> '+
                            '<span class="pull-right font-xs text-muted"><i>'+convert_date_to_format(notify_task[u].wfTask_timeCreated)+'</i></span></span></span></li>';
                        $('#content-notify-task').append(html);
                    });
                    $('.total_notification').html(notify_task.length);
                }
//                if ($('#user_type').val() == '1') {
