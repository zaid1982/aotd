...
class Class_user {
    ...
    public function register_new_industry($user_id, $wfGroup_id, $jasFileNo) {
        try {
            ...
            if (empty($premise)) 
                throw new Exception('(ErrCode:1201) [' . __LINE__ . '] - JAS File No. not exist.', 35);
            else if ($premise['STATUSPREMIS'] == 'Tutup') 
                throw new Exception('(ErrCode:1202) [' . __LINE__ . '] - Your premise currently recorded as Closed. Please update your eKAS system profile.', 35);
