...
<!--                            <li>
            ...
            <div class="pull-right">
                ...
                <div id="ss" class="btn-header pull-right">
                    <span> <a href="javascript:void(0);" data-toggle="modal" title="User Profile" onclick="f_mus_load_user(3,<?=$_SESSION['user_id']?>,'idx');"><i class="fa fa-user"></i></a> </span>
                </div>
