...
<html lang="en-us" id="extr-page">
    ...
    <body class="animated">
        <header id="header" style="min-height:120px;">
            <div class="text-center" id="logo-group">
                <img src="img/lims-logo3.png" height="120px">
            </div>            
            <div class="pull-right hidden-mobile hidden-md hidden-sm hidden-xs">
                <br/>
                <span class="about-heading" style="color:white;"><strong>Malaysian Palm Oil Board</strong></span><br/>
                <span class="about-heading font-sm" style="color:white;">No 6, Persiaran Institusi, Bandar Baru Bangi <br/>43000 Kajang, Selangor Malaysia</span><br/>
                <span class="about-heading font-sm" style="color:white;">General Line: <strong>603 - 8769 4400</strong> <br/>Fax Number  : <strong>603 - 8925 9446</strong></span>
            </div>
            <div class="pull-right hidden-mobile hidden-md hidden-sm hidden-xs">
                <img src="img/mpob-header3.png" height="120px">
            </div>
        </header>    
        <div id="main" role="main">
            ...
            <div id="content" class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-mobile hidden-sm hidden-xs">
                        <!-- well -->
                        <div class="">
                            <div id="myCarousel" class="carousel fade" >
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        ...
                                        <div class="carousel-caption caption-right"></div>
                                    </div>
                                    <div class="item">
        ...
        <div class="page-footer" style="background-color: #008478">
            <div class="row">
                <span class="txt-color-white">
                    <span>A.O.T.D - Laboratory Information Management System 2.0 © 2017</span>
            </div>
        </div>
