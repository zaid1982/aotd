                    ...
                    <div>
                        <div class="widget-body no-padding">
                            <div class="table-responsive">                                
                                <table id="datatable_aud" class="table table-striped table-bordered table-hover" width="100%">
                                    <thead>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th data-hide="phone" width="12%">IC No.</th>               
                                            <th data-hide="phone" width="12%">Role</th>         
                                            <th data-hide="phone,tablet" width="10%">IP Address</th>
