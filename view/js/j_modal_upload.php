<script type="text/javascript">
                ...
                mup_file : {
                    validators : {
                        ...
                        file: {
                            ...
                            maxSize: '5000000',
                            message: 'Only PDF, jpeg, jpg and png format allowed.'
                        }          
                    }
                }
            }
                        ...
                        success: function(resp) {
                            if (resp.success == true){ 
                                ...
                                if (mup_otable == 'mpcr') {
                                    ...
                                    data_mpcr_upload = f_get_general_info_multiple('dt_document', {wfTrans_id:$('#mup_wfTrans_id').val()}, {}, '', 'document_sampleCode');
                                    f_dataTable_draw(mpcr_otable_upload, data_mpcr_upload, 'datatable_mpcr_upload', 6);
                                } else if (mup_otable == 'mfcr') {
                                    f_save_audit('315', $('#mup_document_sampleCode').val());
                                    data_mfcr_upload = f_get_general_info_multiple('dt_document', {wfTrans_id:$('#mup_wfTrans_id').val()}, {}, '', 'document_sampleCode');
                                    f_dataTable_draw(mfcr_otable_upload, data_mfcr_upload, 'datatable_mfcr_upload', 6);
                                } else if (mup_otable == 'macr') {
                                    f_save_audit('115', $('#mup_document_sampleCode').val());
                                    data_macr_upload = f_get_general_info_multiple('dt_document', {wfTrans_id:$('#mup_wfTrans_id').val()}, {}, '', 'document_sampleCode');
                ...
                $('#modal_waiting').on('shown.bs.modal', function(e){
                    if (f_submit_normal('delete_file', {document_id:document_id}, 'p_upload', 'Document successfully deleted.')) {
                        ...
                        if (otable == 'mpcr') {         
                            ...
                            data_mpcr_upload = f_get_general_info_multiple('dt_document', {wfTrans_id:$('#mpcr_wfTrans_id').val()}, {}, '', 'document_sampleCode');
                            f_dataTable_draw(mpcr_otable_upload, data_mpcr_upload, 'datatable_mpcr_upload', 6);
                        } else if (otable == 'mfcr') {
    ...
    function f_mup_load_upload(load_type, ids, wfTrans_id, otable) {
        $('#modal_waiting').on('shown.bs.modal', function(e){
